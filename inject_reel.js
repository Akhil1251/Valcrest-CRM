...
// We will replace the return statement with the reel layout.
const newReturn = `  return (
    <div className="h-screen bg-black overflow-hidden relative w-full">
      
      {/* The Reel Container (150vw total, 3 panes of 50vw each) */}
      <div 
      ...
      >
        ...
        <div className="w-[50vw] h-full relative flex flex-col items-center justify-center px-4 py-4 lg:py-8 bg-black overflow-y-auto">
          {/* Grain Overlay */}
          <div
        ...
        {/* PANE 2: Logo Animation (50vw) */}
        <div className={\`w-[50vw] h-full relative flex items-center justify-center bg-black overflow-hidden transition-all duration-[2000ms] ease-in-out \${isSuccessAnimating ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}\`}>
        ...
        {/* PANE 3: Login Form (50vw) */}
        <div className={\`w-[50vw] h-full relative flex flex-col items-center justify-center px-4 py-4 lg:py-8 bg-black overflow-y-auto transition-all duration-[2000ms] ease-in-out \${isSuccessAnimating ? 'opacity-0 translate-x-full' : 'opacity-100 translate-x-0'}\`}>
          <div
            className="absolute inset-0 z-0 opacity-[0.05] pointer-events-none mix-blend-overlay"
            style={{ backgroundImage: 'url("https://grainy-gradients.vercel.app/noise.svg")' }}
          />
...
content = content.replace(/return \(\s*<div className="flex h-screen bg-black overflow-hidden">[\s\S]*?\);\s*\n\}$/, newReturn + '\n}');

fs.writeFileSync(path, content);
console.log('Successfully injected reel layout');
